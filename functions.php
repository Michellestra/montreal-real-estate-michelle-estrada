...
function add_my_menus() {
    register_nav_menus(
    array(
        'header-menu' => __( 'Header Menu', 'montreal-real-estate-michelle-estrada' ),
        'footer-menu' => __( 'Footer Menu', 'montreal-real-estate-michelle-estrada' ),
        'social-menu' => __( 'Social Menu', 'montreal-real-estate-michelle-estrada'),
